...
protoc \
    ...
    user.proto hwsc-user-svc.proto identification.proto
...
protoc \
    ...
    document.proto hwsc-document-svc.proto identification.proto
...
python3.7 -m grpc_tools.protoc \
    ...
    hwsc-file-transaction-svc.proto identification.proto
