...
type FileMetadata struct {
	...
	Fuid []byte `protobuf:"bytes,1,opt,name=fuid,proto3" json:"fuid,omitempty" bson:"fuid"`
...
func (m *FileMetadata) GetFuid() []byte {
	if m != nil {
		return m.Fuid
	}
	return nil
...
var fileDescriptor_5573547149af4b96 = []byte{
	...
	,
}
