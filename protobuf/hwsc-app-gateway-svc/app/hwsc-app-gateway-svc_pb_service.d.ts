...
import * as protobuf_hwsc_app_gateway_svc_app_hwsc_app_gateway_svc_pb from "../../../protobuf/hwsc-app-gateway-svc/app/hwsc-app-gateway-svc_pb";
...
type AppGatewayServiceGetStatus = {
  ...
  readonly requestType: typeof protobuf_hwsc_app_gateway_svc_app_hwsc_app_gateway_svc_pb.AppGatewayServiceRequest;
  readonly responseType: typeof protobuf_hwsc_app_gateway_svc_app_hwsc_app_gateway_svc_pb.AppGatewayServiceResponse;
};
...
export class AppGatewayServiceClient {
  ...
  getStatus(
    requestMessage: protobuf_hwsc_app_gateway_svc_app_hwsc_app_gateway_svc_pb.AppGatewayServiceRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: protobuf_hwsc_app_gateway_svc_app_hwsc_app_gateway_svc_pb.AppGatewayServiceResponse|null) => void
  ): UnaryResponse;
  getStatus(
    requestMessage: protobuf_hwsc_app_gateway_svc_app_hwsc_app_gateway_svc_pb.AppGatewayServiceRequest,
    callback: (error: ServiceError|null, responseMessage: protobuf_hwsc_app_gateway_svc_app_hwsc_app_gateway_svc_pb.AppGatewayServiceResponse|null) => void
