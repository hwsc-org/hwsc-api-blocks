...
type Document struct {
	...
	StudySite *StudySite `protobuf:"bytes,7,opt,name=study_site,json=studySite,proto3" json:"study_site,omitempty" bson:"studySite"`
	...
	SamplingRate uint32 `protobuf:"varint,11,opt,name=sampling_rate,json=samplingRate,proto3" json:"sampling_rate,omitempty" bson:"samplingRate"`
	...
	ImageUrlsMap map[string]string `protobuf:"bytes,14,rep,name=image_urls_map,json=imageUrlsMap,proto3" json:"image_urls_map,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"imageUrlsMap"`
	// @inject_tag: bson:"audioUrlsMap"
	AudioUrlsMap map[string]string `protobuf:"bytes,15,rep,name=audio_urls_map,json=audioUrlsMap,proto3" json:"audio_urls_map,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"audioUrlsMap"`
	// @inject_tag: bson:"videoUrlsMap"
	VideoUrlsMap map[string]string `protobuf:"bytes,16,rep,name=video_urls_map,json=videoUrlsMap,proto3" json:"video_urls_map,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"videoUrlsMap"`
	// @inject_tag: bson:"fileUrlsMap"
	FileUrlsMap map[string]string `protobuf:"bytes,17,rep,name=file_urls_map,json=fileUrlsMap,proto3" json:"file_urls_map,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"fileUrlsMap"`
	...
	IsPublic             bool     `protobuf:"varint,21,opt,name=is_public,json=isPublic,proto3" json:"is_public" bson:"isPublic"`
	XXX_NoUnkeyedLiteral struct{} `json:"-" bson:"-"`
	XXX_unrecognized     []byte   `json:"-" bson:"-"`
	XXX_sizecache        int32    `json:"-" bson:"-"`
}
...
var fileDescriptor_9d2790a4091b3173 = []byte{
	...
	,
}
